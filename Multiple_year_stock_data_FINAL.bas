...
ws.Activate
    ...
    Dim ColumnsTickerSummary As Range
   
    Set ColumnsTickerSummary = ws.Range("I:L")
    
    ColumnsTickerSummary.Columns.AutoFit
    ...
    ws.Range("O1:P1").Select
    
    Selection.Font.Bold = True
    
    ws.Range("N1:N4").Select
